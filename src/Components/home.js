...
const Home = () => {
  ...
  useEffect(() => {
    if (navOpen) {
      document.getElementById('navBallLine1').style.transform = 'rotateZ(45deg) translate(00000rem, 0.5rem)'
      document.getElementById('navBallLine2').style.transform = 'translateX(5rem)'
      document.getElementById('navBallLine3').style.transform = 'rotateZ(-45deg) translate(0.1rem, -0.6rem)'
      ...
      document.getElementById('mainNavBall').style.width = '250px'
      document.getElementById('mainNavBall').style.height = '250px'
    } else {
      document.getElementById('navBallLine1').style.transform = 'rotateZ(0deg) translate(0rem, 0rem)'
      document.getElementById('navBallLine2').style.transform = 'translateX(0rem)'
      document.getElementById('navBallLine3').style.transform = 'rotateZ(0deg) translate(0rem, 0rem)'
  ...
  return (
    <>
      <div className={Classes.container}>
        <div className={Classes.mainNavBall} id="mainNavBall">
        </div>
